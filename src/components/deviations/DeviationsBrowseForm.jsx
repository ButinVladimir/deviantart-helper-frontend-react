...
DeviationsBrowseForm.propTypes = {
  ...
  publishedTimeBegin: PropTypes.oneOf(PropTypes.string, PropTypes.number).isRequired,
  publishedTimeEnd: PropTypes.oneOf(PropTypes.string, PropTypes.number).isRequired,
